...
class MapsFragment : Fragment() {
    ...
    private val callback = OnMapReadyCallback { googleMap ->
         ...
         * instalarlo dentro de SupportMapFragment. Este método solo se activará una vez que
         * el usuario ha instalado los servicios de Google Play y ha vuelto a la aplicación.
         */
